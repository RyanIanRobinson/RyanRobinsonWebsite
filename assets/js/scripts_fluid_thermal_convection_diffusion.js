...
// Load header and footer for this project
document.addEventListener("DOMContentLoaded", function () {
    loadComponent("header-container", "/includes/header.html");  // Absolute path
    loadComponent("footer-container", "/includes/footer.html");  // Absolute path
});

// Hardcoded script contents for Fluid Thermal Convection Diffusion
const scriptContents = {
    "fluid_thermal_convection_diffusion_main": 
`
import numpy as np
...
// Function to display script content when a script header is clicked
